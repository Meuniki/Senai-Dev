    ...
    public partial class SpMedicalContext : DbContext
    {
        ...
        protected override void OnConfiguring(DbContextOptionsBuilder optionsBuilder)
        {
            if (!optionsBuilder.IsConfigured)
            {
                ...
                //optionsBuilder.UseSqlServer("Data Source=DESKTOP-RSQ1KON; Initial Catalog=SpMedicalGroup; Integrated Security=True;"); //Integrated Security=True
                //optionsBuilder.UseSqlServer("Data Source=LAB08DESK115999\\SQLEXPRESS; Initial Catalog=SpMedicalGroup; user Id=sa; pwd=senai@132;");
                optionsBuilder.UseSqlServer("Data Source=LAB08DESK115999\\SQLEXPRESS; Initial Catalog=SpMedicalGroup; Integrated Security=True;"); 
            }
        }
