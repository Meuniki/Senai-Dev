...
/// <summary>
/// Controller responsavel pelos endpoints (URLs) referentes aos usuário
/// </summary>
...
{   // Define que o tipo de resposta da API será no formato JSON
    ...
    public class UsuariosController : ControllerBase{
        ...
        public IActionResult Login(UsuarioDomain login){
            ...
            // Busaca o usuário pelo e-mail e senha
            UsuarioDomain usuarioBuscado = _usuarioRepository.BuscarPorEmailSenha(login.email, login.senha);

            // Caso não encontre nenhum usuário com e-mail e senha informados
            ...
            // Define a chave de acesso ao tokem
            ...
            var token = new JwtSecurityToken(
                ...
                claims: claims,                         // dados definidos acima (linha 55)
